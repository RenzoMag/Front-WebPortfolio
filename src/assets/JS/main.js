...
function alertaokgi() {
  ...
  document.getElementById("alert").style =
    "position: relative; left: 0px; transition: left 550ms;";
  setTimeout(alertaokgo, 2500);

  function alertaokgo() {
    document.getElementById("alert").style =
      "position: relative; left: 300px; transition: left 550ms;";
    setTimeout(out, 550);
...
window.addEventListener("scroll", () => {
  ...
  if (window.pageYOffset > 756) {
    document.getElementsByClassName("nbcont")[0].style =
      "position: fixed; background: linear-gradient(180deg, rgba(26,36,48,1) 89%, rgba(255,255,255,0.3) 100%);";
    document.getElementById("pipp").style = "position: relative; bottom: 3px;";
  } else {
    document.getElementsByClassName("nbcont")[0].style =
      "position: ; background: rgb(26,36,48);";
  ...
  if (window.innerWidth >= 1151) {
    if (window.pageYOffset < 1900 && window.pageYOffset > 299) {
      document.getElementById("abb").style =
        "color: #d51c6c; font-weight: 600 !important;";
    } else {
  ...
  if (window.innerWidth >= 1151) {
    if (window.pageYOffset > 1898 && window.pageYOffset < 2700) {
      document.getElementById("hiss").style =
        "color: #d51c6c; font-weight: 600 !important;";
    } else {
  ...
  if (window.innerWidth >= 1151) {
    if (window.pageYOffset > 2698 && window.pageYOffset < 3368) {
      document.getElementById("exx").style =
        "color: #d51c6c; font-weight: 600 !important;";
    } else {
  ...
  if (window.innerWidth >= 1151) {
    if (window.pageYOffset > 3368) {
      document.getElementById("contt").style =
        "color: #d51c6c; font-weight: 600 !important;";
    } else {
